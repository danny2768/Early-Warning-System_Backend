...
export const seedData = {
    ...
    stations: [
        { name: 'Station 1', city: 'City 1', state: 'State 1', countryCode: 'AD', coordinates: { longitude: 1.601554, latitude: 42.546245 }, isVisibleToUser: true },
        { name: 'Station 2', city: 'City 2', state: 'State 2', countryCode: 'AK', coordinates: { longitude: -154.493062, latitude: 63.588753 }, isVisibleToUser: true },
        { name: 'Station 3', city: 'City 3', state: 'State 3', countryCode: 'AE', coordinates: { longitude: 53.847818, latitude: 23.424076 }, isVisibleToUser: true },
        { name: 'Station 4', city: 'City 4', state: 'State 4', countryCode: 'AL', coordinates: { longitude: -86.902298, latitude: 32.318231 }, isVisibleToUser: true },
    ],
    sensors: [
